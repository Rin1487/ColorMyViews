...
//        setContentView(R.layout.activity_main)
    ...
    private fun setListeners(){
        val clickableViews: List<View> =
            listOf(binding.boxOneText, binding.boxTwoText,
    ...
    private fun makeColored(view: View) {
        when (view.id) {
            ...
            R.id.red_button -> binding.boxThreeText.setBackgroundResource(yellow)
            R.id.yellow_button -> binding.boxFourText.setBackgroundResource(red)
            R.id.green_button -> binding.boxFiveText.setBackgroundResource(green)
